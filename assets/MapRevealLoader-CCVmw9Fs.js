var Fe=Object.defineProperty;var Ie=(t,e,r)=>e in t?Fe(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var p=(t,e,r)=>Ie(t,typeof e!="symbol"?e+"":e,r);import{aq as b,ar as ve,as as Re,at as Pe,au as Oe,av as Te,aw as xe,ax as W,r as d,ay as Ve,az as Ne,j as X,aA as Ge,aB as ke,aC as le,aD as Y,Y as ze,aE as He,aF as We,aG as Xe,aH as fe,aI as Ye,aJ as je,aK as qe,aL as Z,aM as Ke}from"./index-BtG0FolT.js";import{useUserStore as Ze}from"./userStore-DTsZsJmo.js";const $e=t=>{const e=Math.min(Math.max(t,0),1);return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2},Je=(t,e)=>t>=e?{kx:1,ky:e/t}:{kx:t/e,ky:1},Qe=(t,e,r,a,o)=>{const n=.5+(t-r.fx)*r.z,i=.5+(e-r.fy)*r.z;return{x:.5+(n-.5)/a,y:.5+(i-.5)/o}},et=(t,e)=>{const r=(t-b[0])/(ve*.5),a=(e-b[1])/(Re*.5)*Pe;return Math.hypot(r,a)},tt=()=>Math.max(...[[0,0],[1,0],[0,1],[1,1]].map(([e,r])=>et(e,r)))*1.05,ue=(t,e,r,a)=>{const o=$e(t),n=e[0],i=e[1],l=n,f=i+Oe,u=1-o,E=u*u*n+2*u*o*l+o*o*r.fx,x=u*u*i+2*u*o*f+o*o*r.fy,v=a+(r.z-a)*o;return{fx:E,fy:x,z:v}},me=12/820,he=t=>{const e=Math.min(Math.max(t,0),1);return e*e*(3-2*e)},rt=t=>{let e=t>>>0;return()=>{e|=0,e=e+1831565813|0;let r=Math.imul(e^e>>>15,1|e);return r=r+Math.imul(r^r>>>7,61|r)^r,((r^r>>>14)>>>0)/4294967296}},at=(t,e=7)=>{const r=rt(e),a=(c,L)=>c+(L-c)*r(),o=new Float32Array(t),n=new Float32Array(t),i=new Float32Array(t),l=new Float32Array(t),f=new Float32Array(t),u=new Float32Array(t),E=new Float32Array(t),x=new Float32Array(t),v=new Float32Array(t),g=new Float32Array(t);for(let c=0;c<t;c++)o[c]=a(0,Math.PI*2),n[c]=r(),i[c]=a(.5,1.1),l[c]=a(1,2.3)*me,f[c]=a(.2,1.2)*me,u[c]=a(.3,1.3)/820,E[c]=a(0,Math.PI*2),x[c]=a(.5,1.05),v[c]=a(-.015,.02),g[c]=a(.5,.85);return{count:t,ang:o,phase:n,life:i,rise:l,rout:f,jamp:u,jph:E,brt:x,roff:v,big:g,outUV:new Float32Array(t*2),outB:new Float32Array(t),outSize:new Float32Array(t),activeCount:0}},ot=(t,e,r)=>{let a=0;for(let o=0;o<t.count;o++){const n=t.life[o],i=((r/n+t.phase[o])%1+1)%1,l=he(i/.25)*he((1-i)/.5);if(l<.02)continue;const f=i*n,u=t.ang[o],E=Math.cos(u),x=Math.sin(u),v=e+t.roff[o];let g=b[0]+ve*v*E/2,c=b[1]+Re*v*x/2/Pe;c-=t.rise[o]*f,g+=t.rout[o]*f*E+t.jamp[o]*Math.sin(6*f+t.jph[o]),c+=t.rout[o]*f*x,t.outUV[a*2]=g,t.outUV[a*2+1]=c,t.outB[a]=t.brt[o]*l,t.outSize[a]=t.big[o],a++}t.activeCount=a},nt=.999,it=({elapsedMs:t,progress:e,revealP0:r,holdMs:a=Te,revealMs:o=xe})=>{const n=Math.min(1,Math.max(0,e));let i=r,l=0;t>=a&&(i<0&&(i=n),l=Math.min(1,(t-a)/o));const f=i<0?0:i>=.999?1:Math.min(1,Math.max(0,(n-i)/(1-i)));return{maskProgress:Math.max(l,f),revealP0:i}},st=t=>t>=nt,ct=`
...
`,de=(t,e,r)=>{const a=t.createShader(e);if(!a)throw new Error("createShader failed");if(t.shaderSource(a,r),t.compileShader(a),!t.getShaderParameter(a,t.COMPILE_STATUS)){const o=t.getShaderInfoLog(a);throw t.deleteShader(a),new Error(`shader compile error: ${o??"unknown"}`)}return a},Ee=(t,e,r)=>{const a=t.createProgram();if(!a)throw new Error("createProgram failed");if(t.attachShader(a,de(t,t.VERTEX_SHADER,e)),t.attachShader(a,de(t,t.FRAGMENT_SHADER,r)),t.linkProgram(a),!t.getProgramParameter(a,t.LINK_STATUS)){const o=t.getProgramInfoLog(a);throw t.deleteProgram(a),new Error(`program link error: ${o??"unknown"}`)}return a},j=(t,e)=>{const r=t.createTexture();if(!r)throw new Error("createTexture failed");return t.bindTexture(t.TEXTURE_2D,r),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.LINEAR),t.texImage2D(t.TEXTURE_2D,0,t.RGBA,t.RGBA,t.UNSIGNED_BYTE,e),r};class mt{constructor(e,r){p(this,"gl");p(this,"revealProg");p(this,"particleProg");p(this,"quadBuf");p(this,"partBuf");p(this,"texReal");p(this,"texBlue");p(this,"texDepth");p(this,"disposed",!1);p(this,"rl");p(this,"pl");this.gl=e,this.revealProg=Ee(e,ct,lt),this.particleProg=Ee(e,ft,ut);const a=new Float32Array([-1,-1,3,-1,-1,3]),o=e.createBuffer();if(!o)throw new Error("createBuffer failed");this.quadBuf=o,e.bindBuffer(e.ARRAY_BUFFER,o),e.bufferData(e.ARRAY_BUFFER,a,e.STATIC_DRAW);const n=e.createBuffer();if(!n)throw new Error("createBuffer failed");this.partBuf=n,e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),this.texReal=j(e,r.real),this.texBlue=j(e,r.blue),this.texDepth=j(e,r.depth),e.useProgram(this.revealProg),e.uniform1i(e.getUniformLocation(this.revealProg,"uReal"),0),e.uniform1i(e.getUniformLocation(this.revealProg,"uBlue"),1),e.uniform1i(e.getUniformLocation(this.revealProg,"uDepth"),2),this.rl={aPos:e.getAttribLocation(this.revealProg,"aPos"),uProgress:e.getUniformLocation(this.revealProg,"uProgress"),uTime:e.getUniformLocation(this.revealProg,"uTime"),uCam:e.getUniformLocation(this.revealProg,"uCam"),uCover:e.getUniformLocation(this.revealProg,"uCover"),uArena:e.getUniformLocation(this.revealProg,"uArena"),uMaxR:e.getUniformLocation(this.revealProg,"uMaxR")},e.useProgram(this.particleProg),e.uniform3f(e.getUniformLocation(this.particleProg,"uColor"),W[0],W[1],W[2]),this.pl={aPos:e.getAttribLocation(this.particleProg,"aPos"),aB:e.getAttribLocation(this.particleProg,"aB"),aSize:e.getAttribLocation(this.particleProg,"aSize"),uPointScale:e.getUniformLocation(this.particleProg,"uPointScale")}}render(e){if(this.disposed)return;const r=this.gl,{drawingBufferWidth:a,drawingBufferHeight:o}=r;if(r.viewport(0,0,a,o),r.clearColor(0,0,0,1),r.clear(r.COLOR_BUFFER_BIT),r.disable(r.BLEND),r.useProgram(this.revealProg),r.bindBuffer(r.ARRAY_BUFFER,this.quadBuf),r.enableVertexAttribArray(this.rl.aPos),r.vertexAttribPointer(this.rl.aPos,2,r.FLOAT,!1,0,0),r.activeTexture(r.TEXTURE0),r.bindTexture(r.TEXTURE_2D,this.texReal),r.activeTexture(r.TEXTURE1),r.bindTexture(r.TEXTURE_2D,this.texBlue),r.activeTexture(r.TEXTURE2),r.bindTexture(r.TEXTURE_2D,this.texDepth),r.uniform1f(this.rl.uProgress,e.progress),r.uniform1f(this.rl.uTime,e.timeSec),r.uniform3f(this.rl.uCam,e.camFx,e.camFy,e.camZoom),r.uniform2f(this.rl.uCover,e.coverKx,e.coverKy),r.uniform2f(this.rl.uArena,e.arenaX,e.arenaY),r.uniform1f(this.rl.uMaxR,e.maxR),r.drawArrays(r.TRIANGLES,0,3),e.particleCount>0){r.enable(r.BLEND),r.blendFunc(r.ONE,r.ONE),r.useProgram(this.particleProg),r.bindBuffer(r.ARRAY_BUFFER,this.partBuf),r.bufferData(r.ARRAY_BUFFER,e.particleData.subarray(0,e.particleCount*4),r.DYNAMIC_DRAW);const n=16;r.enableVertexAttribArray(this.pl.aPos),r.vertexAttribPointer(this.pl.aPos,2,r.FLOAT,!1,n,0),r.enableVertexAttribArray(this.pl.aB),r.vertexAttribPointer(this.pl.aB,1,r.FLOAT,!1,n,8),r.enableVertexAttribArray(this.pl.aSize),r.vertexAttribPointer(this.pl.aSize,1,r.FLOAT,!1,n,12),r.uniform1f(this.pl.uPointScale,e.pointScale),r.drawArrays(r.POINTS,0,e.particleCount),r.disable(r.BLEND)}}dispose(){if(this.disposed)return;this.disposed=!0;const e=this.gl;e.deleteProgram(this.revealProg),e.deleteProgram(this.particleProg),e.deleteBuffer(this.quadBuf),e.deleteBuffer(this.partBuf),e.deleteTexture(this.texReal),e.deleteTexture(this.texBlue),e.deleteTexture(this.texDepth)}}const Ae="/zero-nav-lab/zero-city-loader.webp?v=10001",K="/zero-nav-lab/blueprint.webp",_e="/zero-nav-lab/depth.webp";Z(Ae);Z(K);Z(_e);const ht=4096,pe=15e3,q=async t=>{const e=new Image;e.src=t;let r;const a=new Promise((u,E)=>{r=setTimeout(()=>E(new Error(`texture decode timed out after ${pe}ms: ${t}`)),pe)});try{await Promise.race([e.decode(),a])}finally{r&&clearTimeout(r)}const o=Math.min(1,ht/Math.max(e.naturalWidth,e.naturalHeight)),n=Math.max(1,Math.round(e.naturalWidth*o)),i=Math.max(1,Math.round(e.naturalHeight*o)),l=document.createElement("canvas");l.width=n,l.height=i;const f=l.getContext("2d");if(!f)throw new Error("2d context failed");return f.drawImage(e,0,0,n,i),l},dt=()=>{const t=document.createElement("canvas");t.width=2,t.height=2;const e=t.getContext("2d");return e&&(e.fillStyle="#0a3d33",e.fillRect(0,0,t.width,t.height)),t},Rt=({progress:t,onDone:e,forceFinish:r=!1,manageAppReadyFlag:a=!0,timingScale:o=1,zoomTargetCompanyId:n=null})=>{const i=d.useRef(null),l=d.useRef(null),f=d.useRef(null),u=d.useRef(t);u.current=t;const E=d.useRef(e);E.current=e;const x=d.useRef(r);x.current=r;const v=d.useRef(o);v.current=o;const g=d.useRef(n);g.current=n;const c=d.useRef(!1),L=d.useCallback(()=>{c.current||(c.current=!0,E.current())},[]),F=Ve(m=>m.setSplashActive);return d.useEffect(()=>{if(a)return F(!0),()=>F(!1)},[F,a]),d.useEffect(()=>{r&&L()},[r,L]),d.useEffect(()=>{const m=f.current;if(!m)return;let I=0,S=null,O=!1,$=!1;const ge=je/qe,J=tt(),y=at(fe),C=new Float32Array(fe*4),B=[.5,.5],M=v.current>0?v.current:1,Le=Te*M,we=xe*M,Se=Ye*M,V=We*M,ye=Xe*M,Me=Ke*M,Q=g.current;Ne();const ee=()=>{var s,R,P;return Q??((P=(R=(s=ze.getState().user)==null?void 0:s.currentScenario)==null?void 0:R.company_data)==null?void 0:P.id)},te=()=>{const s=Ge(ee());return{fx:s.fx,fy:s.fy,z:s.z||ke}};let N=te();const be=()=>Q!=null||!!Ze.getState().userName,Ce=()=>He(ee());let A="reveal",G=performance.now(),k=0,z=0,H=0,re=-1,U=le,ae=!1;const Ue=()=>{const s=Math.min(window.devicePixelRatio||1,2),R=Math.round(m.clientWidth*s),P=Math.round(m.clientHeight*s);(m.width!==R||m.height!==P)&&(m.width=R,m.height=P)},oe=()=>{if(O)return;if(x.current){L();return}const s=performance.now(),R=(s-G)/1e3,P=Math.min(Math.max(u.current,0),1);let w={fx:B[0],fy:B[1],z:Y},T=P,D=1;if(A==="reveal"){const _=it({elapsedMs:s-G,progress:P,revealP0:re,holdMs:Le,revealMs:we});re=_.revealP0,T=_.maskProgress,st(P)&&T>=le&&(U=T,be()&&Ce()?(N=te(),A="drone",k=s):(ae=!0,A="settle",z=s))}if(A==="drone"){const _=Math.min(1,(s-k)/V);T=U+(1-U)*_;const h=Math.min((s-k)/Se,1);w=ue(h,B,N,Y),h>=1&&(A="fade",H=s)}if(A==="settle"){const _=Math.min(1,(s-z)/V);T=U+(1-U)*_,s-z>=V+ye&&(A="fade",H=s)}A==="fade"&&(T=1,ae||(w=ue(1,B,N,Y)),D=Math.max(0,1-(s-H)/Me)),Ue();const{kx:ne,ky:ie}=Je(m.width/m.height,ge);let se=0;if(A==="reveal"){ot(y,T*J,R);const _=y.activeCount;for(let h=0;h<_;h++){const De=y.outUV[h*2],Be=y.outUV[h*2+1],ce=Qe(De,Be,w,ne,ie);C[h*4]=ce.x,C[h*4+1]=ce.y,C[h*4+2]=y.outB[h],C[h*4+3]=y.outSize[h]}se=_}if(S==null||S.render({progress:T,timeSec:R,camFx:w.fx,camFy:w.fy,camZoom:w.z,coverKx:ne,coverKy:ie,arenaX:b[0],arenaY:b[1],maxR:J,pointScale:Math.min(window.devicePixelRatio||1,2)*5,particleData:C,particleCount:se}),$||($=!0,l.current&&(l.current.style.display="none")),i.current&&(i.current.style.opacity=String(D)),A==="fade"&&D<=0){L();return}I=requestAnimationFrame(oe)};return(async()=>{try{const[s,R,P]=await Promise.all([q(Ae).catch(D=>(console.warn("[MapRevealLoader] real texture decode failed; using placeholder",D),null)),q(K),q(_e)]);if(O)return;const w=s??R??dt(),T=m.getContext("webgl",{antialias:!0,premultipliedAlpha:!1})??m.getContext("experimental-webgl",{antialias:!0});if(!T)throw new Error("WebGL unavailable");S=new mt(T,{real:w,blue:R,depth:P}),G=performance.now(),I=requestAnimationFrame(oe)}catch(s){console.error("[MapRevealLoader] init failed",s),L()}})(),()=>{O=!0,cancelAnimationFrame(I),S==null||S.dispose()}},[L]),X.jsxs("div",{ref:i,style:{position:"fixed",inset:0,zIndex:999999,background:"#0a3d33"},children:[X.jsx("img",{ref:l,src:K,alt:"","aria-hidden":!0,draggable:!1,style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}),X.jsx("canvas",{ref:f,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})]})};export{Rt as MapRevealLoader,Rt as default};
